...
struct ListWidgetConfigurationIntent: WidgetConfigurationIntent {
  ...
  public static var defaultValue: ListWidgetConfigurationIntent {
    ...
    let snippetList2  = SnippetList(id: "-1", type: SnippetType.MULTIPLE.rawValue, source: SnippetSource.API.rawValue, title: "Snippet List 2", content: "This is snippet list 2!", color_id: 1, order_index: 1, snippets: [])
    let snippet6 = SnippetList(id: "-1", type: SnippetType.SINGLE.rawValue, source: SnippetSource.API.rawValue, title: "Snippet 6", content: "This is snippet 6!", color_id: 2, order_index: 2, snippets: [])
    let snippet7 = SnippetList(id: "-1", type: SnippetType.SINGLE.rawValue, source: SnippetSource.API.rawValue, title: "Snippet 7", content: "This is snippet 7!", color_id: 3, order_index: 3, snippets: [])
    return ListWidgetConfigurationIntent(snippetList: SnippetList(id: "-1", type: SnippetType.MULTIPLE.rawValue, source: SnippetSource.API.rawValue, title: "Snippets", content: "These are snippets!", color_id: 100, order_index: 0, snippets: [snippet1, snippet2, snippetList1, snippet3, snippet4, snippet5, snippetList2, snippet6, snippet7]))
  }
}
